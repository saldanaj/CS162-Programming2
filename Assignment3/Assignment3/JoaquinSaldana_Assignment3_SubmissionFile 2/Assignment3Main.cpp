...
int main()
{
    ...
    // UNTIL THE USER ENTERS THE NUMBER 0 TO EXIT THE PROGRAM THE PROGRAM WILL CONTINUE ASKING HIM TO
    // TO SELECT TWO FIGHTERS AND THEY WILL COMBAT UNTIL ONE WINS
    ...
    while(toExit != 0)
    {
        ...
        // BOOLEAN STMTS WHICH INFORM THE USER WHO'S THE WINNER OR IF IT'S DRAW
        ...
        // ASKING USER IF THEY WISH TO TERMINATE THE PROGRAM
        
        while(utility1.getUtilitiesFlag() == false)
        {
            if(utility1.isANumber(toExit, prompt3) == false)
            {
